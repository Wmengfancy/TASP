function [preCache,preTaskComputationSpeed,preFinishTime,bestUserFinishTime] = P1_IterateNum_network_addFinishtime(Iterationnum,Tasknum,userNum,Servernum,ServerMemory,TaskMemory,Possionrate,Taskgraph,Transferrate,Transferrate_network,Computespeed_Local,ComputeSpeed_server)
%在P1_IterateNum的基础上，考虑了服务器的连通性，加入输入参数Transferrate_network
...
%[preTaskComputationSpeed,preFinishTime] = P2_RankOnNum(Tasknum,userNum,Servernum,preCache,Possionrate,Possionrate_sum,Taskgraph,Transferrate,Computespeed_Local,ComputeSpeed_server);
 [preTaskComputationSpeed,preFinishTime,bestUserFinishTime] = P2_network_addFinishtime(Tasknum,userNum,Servernum,preCache,Possionrate,Possionrate_sum,Taskgraph,Transferrate,Transferrate_network,Computespeed_Local,ComputeSpeed_server);
