function [preCache,preTaskComputationSpeed,preFinishTime] = P1_w(w,Tasknum,userNum,Servernum,ServerMemory,TaskMemory,Possionrate,Taskgraph,Transferrate,Computespeed_Local,ComputeSpeed_server)
...
%w = 3;%这个参数的设置，会影响到缓存策略是否容易改变
Iterationnum = 8000;%这里暂时以迭代10000次作为结束条件。结束条件是否应该是每次得到的时间波动很小？
cur_iteNum = 0;
