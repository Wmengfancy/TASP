function [preCache,preTaskComputationSpeed,preFinishTime] = P3(Tasknum,userNum,Servernum,ServerMemory,TaskMemory,Possionrate,Taskgraph,Transferrate,Computespeed_Local,ComputeSpeed_server)
%P1_RankOnNum是Gibbs sampling算法，P3是后来大佬把算法改了，随机给DAG根节点选一个服务器，
%   按照通信速度最快的原则为其他任务选择缓存的服务器
