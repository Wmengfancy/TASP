function [preCache,preTaskComputationSpeed,preFinishTime] = P1_IterateNum_network(Iterationnum,Tasknum,userNum,Servernum,ServerMemory,TaskMemory,Possionrate,Taskgraph,Transferrate,Transferrate_network,Computespeed_Local,ComputeSpeed_server)
