function [preCache,preTaskComputationSpeed,preFinishTime] = P1_iwqos_network_taskset(taskset,Tasknum,userNum,Servernum,ServerMemory,TaskMemory,Possionrate,Taskgraph,Transferrate,Transferrate_network,Computespeed_Local,ComputeSpeed_server)
